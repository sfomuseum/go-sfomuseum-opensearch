module github.com/sfomuseum/go-sfomuseum-opensearch
...
require (
	...
	github.com/sfomuseum/go-sfomuseum-instagram v0.3.0
	...
	github.com/whosonfirst/go-whosonfirst-opensearch/v4 v4.2.5
